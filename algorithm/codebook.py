...
class Codebook(object):
    ...
    def __init__(self, encoder, dataset, embed_bb):
        ...
        # embedding_size = self._dataset.embedding_size # num of views
        embedding_size = self._dataset.noof_training_imgs
        
        # normalized_embedding_query : test data
        # embedding_normalized : codebook
        ...
        # cos_similarity : inner product of two normalized vector
    ...
    def test_embedding(self, sess, x):
        ...
        return sess.run(self.embedding_normalized,{self._encoder.x: x})
        '''
        if normalized:
    ...
    def update_embedding_grasp(self, session, batch_size):
        ...
        for a, e in u.batch_iteration_indices(embedding_size, batch_size):
            ...
            batch = self._dataset.batch_embedding_grasp(a,e)
            embedding_z[a:e] = session.run(self._encoder.z, feed_dict={self._encoder.x: batch})
