...
def build_codebook_from_name(para, return_dataset=False, return_decoder = False):
    ...
    dataset_path = para['view_dataset_path']
    cfg_file_path = para['cfg_file_path']
